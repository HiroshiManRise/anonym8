...
# Install script for anonym8
	...
	echo -e "This script will install anonym8 script."
	sleep 1
	...
	sleep 1
	apt-get install tor macchanger resolvconf dnsmasq polipo privoxy i2p tor-arm libnotify-bin curl bleachbit
	sleep 1
	...
	sleep 1
	chmod +x /etc/init.d/anonym8.sh /usr/bin/anonym8 /usr/bin/anON /usr/bin/anOFF
	sleep 1
